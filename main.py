...
class EventsThread:
    def __init__(self, bot):
        ...
        self._photon_packet_parser = PhotonPacketParser(
            on_event=self._events_handler.on_event,
            on_request=self._events_handler.on_request,
            on_response=self._events_handler.on_response
        )
    ...
    def run(self):
        scapy.sniff(
            filter="(host 5.45.187 or host 5.188.125) and udp port 5056",
